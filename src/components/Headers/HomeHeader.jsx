    ...
    <div className="row mobile-height">
      ...
      <div className="col-12 col-md-4 d-flex flex-column justify-content-center align-items-start order-1 order-md-1">
        <p style={{ fontSize: 9, opacity: 0.5, fontWeight: 400 }}>
          ...
          Address: 8A Nové sady, Brno, 64 - Czechia / Postal Code: 602 00 
        </p>
      </div>
      ...
      {/* Right section */}
      <div className="col-12 col-md-4 d-flex flex-column justify-content-center align-items-center align-items-md-end order-2 order-md-3">
        <p style={{ fontSize: 9, opacity: 0.5, fontWeight: 400 }}>
